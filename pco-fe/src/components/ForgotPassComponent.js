...
import { changePassword, resetValidation } from "../redux/Authentication/action";
        ...
        <I18nProvider locale={this.props.locales}>
          <div className="mainPageDivs">
            ...
            <form onSubmit={this.handleSubmit}>
              ...
              <label className="formInstructions">
          ...
          <br />
          <Link to="/login"  onClick={ this.props.resetValidation }>{translate("log-in")}</Link>
        </I18nProvider>
      </div>
    );
  }
