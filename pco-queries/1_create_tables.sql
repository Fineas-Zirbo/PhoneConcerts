...
--
-- Host: 127.0.0.1    Database: db_pco
-- ------------------------------------------------------
...
CREATE TABLE `token` (
  ...
  CONSTRAINT `FKqhk1olyr5s4i5hxfif07yuml6` FOREIGN KEY (`login_id`) REFERENCES `login` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-11-25 21:43:51
